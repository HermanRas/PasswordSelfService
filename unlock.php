    ...
    <form name="Unlock" action="unlock_questions.php" method="post" class="form-style-9">
        <ul>
            <li>
                ...
                <input name="CN" type="text" required class="field-style field-full align-none" title="10000001"
                    placeholder="10000001" />
            </li>
            <li>
                <div class="field-style field-full align-none">Domain User Name: <i>petragroup\user</i></div>
                <input name="User" type="text" required class="field-style field-full align-none"
                    title="petragroup\user" placeholder="petragroup\user" />
            </li>
            <li>
